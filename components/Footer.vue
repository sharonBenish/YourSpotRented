    ...
    <div class="w-site lt-sm:px px-6 lg-px-16 pb8 lg:pb15">
      <div class="flex flex-col 2md:flex-row justify-between lg:items-center gap-4">
        <NuxtLink to="/" class="-ml4">
          <img src="/images/Logo.png" class="w45 hauto" />
        </NuxtLink>
        <button @click="goToContact" class="flex text-3.5 items-center gap-2 bg-e-primary px8 py3 rounded-2 text-white font-600 lt-sm:mx-auto lt-sm:mt14 lt-lg:mt18">
          Get In Touch
